...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  1 10:03:44 2022

@author: Fabian da Silva Preckel und Sebastian Merten
"""
...
def get_risikoklasse(alter, sex, ags, year, month_1, month_2): 
    ...
    try:
        ...
        year = int(year)
        ags = int(ags)
        risk_df = pd.read_csv("https://github.com/dasilvafabian/Projektseminar-SS22-Abgabe/blob/main/prognose2020.csv")
        risk_ags = []
